...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .formLogin()
                .loginPage("/auth/login").permitAll() // without this if we want to use basic login form
                .defaultSuccessUrl("/auth/success") // without this if we want to use basic login form
                .and()
                .logout() //change logout was GET -> now POST
